    ...
    return <section className="relative z-50 min-h-[100vh]">
        <div className="relative isolate px-2 py-8 lg:py-20 lg:px-8">
            <div className="flex relative m-14 items-center justify-between flex-col gap-10">
                ...
                <div className="px-10 md:px-20 py-16 bg-gradient-to-l from-customBlueLight to-white dark:from-customBlueDark dark:to-slate-900 w-[100vw] flex flex-col gap-4 items-baseline relative overflow-hidden z-0">
                    <p className="dark:text-white lg:w-2/3"> Love reading manga? Dive into the exciting world of BIS Adventures in a whole new way! Whether you're a fan of epic battles or curious about how standards shape the world around us, the BIS Adventures manga offers an immersive experience filled with unique challenges and fascinating storytelling.</p>
                    <button className="bg-slate-800 text-white dark:bg-white px-4 dark:text-customBlueDark font-semibold cursor-pointer rounded-md">read now</button>
